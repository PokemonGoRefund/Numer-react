...
const Newton =()=>{
    ...
    const CalOnepoint = (start) => {
        ...
        do
        {
            // xnew = math.parse(Equation)
            scope = {
                x:xold,
            }
            FXold = -(calFunction(Equation, scope.x) / calFunction(math.derivative(Equation, 'x').toString(), scope.x))
    ...
    return (
            <Container >
                ...
                <header>
                    ...
                    <h2 className='course-header'>Newton Raphson Method </h2> 
                </header>
